...
const build = './assets/';
const assets = '../assets/components/uniconfig/';

gulp.task('default', ['css', 'js', 'fonts']);

gulp.task('watch', function () {
    gulp.watch([build + 'sass/*.sass', build + 'sass/**/*.sass'], ['sass']);
    gulp.watch([build + 'js/*.js', build + 'js/uniconfig/*.js'], ['js']);
});

gulp.task('css', function () {
    var src = build + 'sass/*.sass';
...
gulp.task('fonts', function () {
		gulp.src(build + 'fonts/**').pipe(gulp.dest(assets + 'fonts/'));
