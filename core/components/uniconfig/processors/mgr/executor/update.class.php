...
class uniConfigExecutorUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('uniconfig_executor_err_ns');
        }
...
return 'uniConfigExecutorUpdateProcessor';
