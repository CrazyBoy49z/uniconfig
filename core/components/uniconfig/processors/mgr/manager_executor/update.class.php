...
class uniConfigManagerExecutorUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('uniconfig_ManagerExecutor_err_ns');
        }
...
return 'uniConfigManagerExecutorUpdateProcessor';
