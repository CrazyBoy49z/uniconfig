...
class uniConfigStatusUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('uniconfig_status_err_ns');
        }
...
return 'uniConfigStatusUpdateProcessor';
