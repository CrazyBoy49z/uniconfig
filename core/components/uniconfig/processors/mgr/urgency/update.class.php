...
class uniConfigUrgencyUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('uniconfig_urgency_err_ns');
        }
...
return 'uniConfigUrgencyUpdateProcessor';
